...
mod random {
    ...
    impl<R: Rng> RandomMethod<R> for Class {
        fn random(rng: &mut R) -> Self {
            match rand::thread_rng().gen_range(0u32..6) {
    ...
    impl<R: Rng> RandomMethod<R> for Connection {
        fn random(rng: &mut R) -> Self {
            match rand::thread_rng().gen_range(0u32..12) {
                0 => Connection::Start {
    ...
    impl<R: Rng> RandomMethod<R> for Exchange {
        fn random(rng: &mut R) -> Self {
            match rand::thread_rng().gen_range(0u32..4) {
                0 => Exchange::Declare {
                    reserved_1: RandomMethod::random(rng),
    ...
    impl<R: Rng> RandomMethod<R> for Queue {
        fn random(rng: &mut R) -> Self {
            match rand::thread_rng().gen_range(0u32..10) {
                0 => Queue::Declare {
                    reserved_1: RandomMethod::random(rng),
    ...
    impl<R: Rng> RandomMethod<R> for Basic {
        fn random(rng: &mut R) -> Self {
            match rand::thread_rng().gen_range(0u32..17) {
                0 => Basic::Qos {
